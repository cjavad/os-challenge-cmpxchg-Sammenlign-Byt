...
static __m256i rotr(const __m128i lower, const __m128i upper, const uint32_t n) {
	return _mm256_insertf128_si256(
		_mm256_castsi128_si256(
			_mm_or_si128(_mm_srli_epi32(lower, n), _mm_slli_epi32(lower, 32 - n))
		),
...
static __m256i s0(const __m256i w) {
	...
	return _mm256_castps_si256(
		_mm256_xor_ps(_mm256_castsi256_ps(t0),
				   _mm256_xor_ps(_mm256_castsi256_ps(t1), _mm256_castsi256_ps(t2))));
}

static __m256i s1(const __m256i w) {
	__m128i upper = _mm256_extractf128_si256(w, 1);
	__m128i lower = _mm256_castsi256_si128(w);
...
static __m256i S0(const __m256i a) {
	__m128i upper = _mm256_extractf128_si256(a, 1);
	__m128i lower = _mm256_castsi256_si128(a);

	return _mm256_castps_si256(
		_mm256_xor_ps(_mm256_castsi256_ps(rotr(lower, upper, 2)),
				   _mm256_xor_ps(_mm256_castsi256_ps(rotr(lower, upper, 13)),
							  _mm256_castsi256_ps(rotr(lower, upper, 22)))));
}

static __m256i S1(const __m256i e) {
	__m128i upper = _mm256_extractf128_si256(e, 1);
	__m128i lower = _mm256_castsi256_si128(e);

	return _mm256_castps_si256(
		_mm256_xor_ps(_mm256_castsi256_ps(rotr(lower, upper, 6)),
				   _mm256_xor_ps(_mm256_castsi256_ps(rotr(lower, upper, 11)),
							  _mm256_castsi256_ps(rotr(lower, upper, 25)))));
}

static __m256i ch(const __m256i e, const __m256i f, const __m256i g) {
	return _mm256_castps_si256(
		_mm256_xor_ps(_mm256_and_ps(_mm256_castsi256_ps(e), _mm256_castsi256_ps(f)),
				   _mm256_andnot_ps(_mm256_castsi256_ps(e), _mm256_castsi256_ps(g))));
}

static __m256i maj(const __m256i a, const __m256i b, const __m256i c) {
	return _mm256_castps_si256(_mm256_xor_ps(
		_mm256_and_ps(_mm256_castsi256_ps(a), _mm256_castsi256_ps(b)),
		_mm256_xor_ps(_mm256_and_ps(_mm256_castsi256_ps(a), _mm256_castsi256_ps(c)),
				   _mm256_and_ps(_mm256_castsi256_ps(b), _mm256_castsi256_ps(c)))));
}

static __m256i _mm256_fake_add_epi32(const __m256i x, const __m256i y) {
	return _mm256_insertf128_si256(
...
void sha256x8_optim(
...

	{
		...
		__m128i 
		 	mask0 = _mm_load_si128((__m128i*)byteswap_mask0),
		...
		__m128i
			hl0 = _mm_shuffle_epi8(ll0, mask0),
		...
		__m256i
			w0 = _mm256_castps_si256(_mm256_blend_ps(_mm256_castsi256_ps(h0), _mm256_castsi256_ps(h1), 0b11001100)),
			w1 = _mm256_castps_si256(_mm256_blend_ps(_mm256_castsi256_ps(h0), _mm256_castsi256_ps(h1), 0b00110011));
	...
	{
		__m128i
			l0 = _mm_load_si128((__m128i*)x80000000),
    ...
    {
        __m256i w17 = _mm256_fake_add_epi32(t1, _mm256_fake_add_epi32(s0(c80), s1(c64)));
...

    {
        ...
        __m256i w30 = _mm256_fake_add_epi32(s0(c64), _mm256_fake_add_epi32(l1, s1(t0)));
        _mm256_store_si256(&w[30], w30);
        t0 = w30;
        l1 = _mm256_load_si256(&w[16]);

        __m256i w31 = _mm256_fake_add_epi32(_mm256_fake_add_epi32(l0, s1(t1)),
	...
	for (uint32_t i = 32; i < 64; i++) {
        ...
        __m256i ws0 = s0(wi15);
        __m256i wi =
            _mm256_fake_add_epi32(_mm256_fake_add_epi32(wi16, wi7), _mm256_fake_add_epi32(ws0, ws1));
        _mm256_store_si256(&w[i], wi);
        t1 = wi;
    }

	__m256
        h0 = _mm256_broadcast_ps((__m128*)&H[0]),
        h1 = _mm256_broadcast_ps((__m128*)&H[4]);

    __m256i
		a = _mm256_castps_si256(_mm256_permute_ps(h0, 0b00000000)),
	...
	for (uint32_t i = 0; i < 64; i++) {
		__m256i
			ki = _mm256_castps_si256(_mm256_broadcast_ss((float*)&k[i])),
			wi = _mm256_load_si256(&w[i]);

		__m256i
			temp2 = _mm256_fake_add_epi32(S0(a), maj(a, b, c)),
	...
	a = _mm256_fake_add_epi32(a, _mm256_castps_si256(_mm256_broadcast_ss((float*)&H[0])));
	b = _mm256_fake_add_epi32(b, _mm256_castps_si256(_mm256_broadcast_ss((float*)&H[1])));
	c = _mm256_fake_add_epi32(c, _mm256_castps_si256(_mm256_broadcast_ss((float*)&H[2])));
	d = _mm256_fake_add_epi32(d, _mm256_castps_si256(_mm256_broadcast_ss((float*)&H[3])));
	e = _mm256_fake_add_epi32(e, _mm256_castps_si256(_mm256_broadcast_ss((float*)&H[4])));
	f = _mm256_fake_add_epi32(f, _mm256_castps_si256(_mm256_broadcast_ss((float*)&H[5])));
	g = _mm256_fake_add_epi32(g, _mm256_castps_si256(_mm256_broadcast_ss((float*)&H[6])));
	h = _mm256_fake_add_epi32(h, _mm256_castps_si256(_mm256_broadcast_ss((float*)&H[7])));
	...
	*/
	...
	__m256
		tmp00 = _mm256_unpacklo_ps(_mm256_castsi256_ps(a), _mm256_castsi256_ps(b)),
		tmp01 = _mm256_unpackhi_ps(_mm256_castsi256_ps(a), _mm256_castsi256_ps(b)),
		tmp02 = _mm256_unpacklo_ps(_mm256_castsi256_ps(c), _mm256_castsi256_ps(d)),
		tmp03 = _mm256_unpackhi_ps(_mm256_castsi256_ps(c), _mm256_castsi256_ps(d)),
		tmp10 = _mm256_unpacklo_ps(_mm256_castsi256_ps(e), _mm256_castsi256_ps(f)),
		tmp11 = _mm256_unpackhi_ps(_mm256_castsi256_ps(e), _mm256_castsi256_ps(f)),
		tmp12 = _mm256_unpacklo_ps(_mm256_castsi256_ps(g), _mm256_castsi256_ps(h)),
		tmp13 = _mm256_unpackhi_ps(_mm256_castsi256_ps(g), _mm256_castsi256_ps(h));
	...
	_mm_store_si128((__m128i*)&hash[0], _mm_shuffle_epi8(_mm256_extractf128_si256(r0, 1), mask));
	_mm_store_si128((__m128i*)&hash[16], _mm_shuffle_epi8(_mm256_castsi256_si128(r0), mask));

	_mm_store_si128((__m128i*)&hash[32], _mm_shuffle_epi8(_mm256_extractf128_si256(r1, 1), mask));
	_mm_store_si128((__m128i*)&hash[48], _mm_shuffle_epi8(_mm256_castsi256_si128(r1), mask));

	_mm_store_si128((__m128i*)&hash[64], _mm_shuffle_epi8(_mm256_extractf128_si256(r2, 1), mask));
	_mm_store_si128((__m128i*)&hash[80], _mm_shuffle_epi8(_mm256_castsi256_si128(r2), mask));

	_mm_store_si128((__m128i*)&hash[96], _mm_shuffle_epi8(_mm256_extractf128_si256(r3, 1), mask));
	_mm_store_si128((__m128i*)&hash[112], _mm_shuffle_epi8(_mm256_castsi256_si128(r3), mask));

	_mm_store_si128((__m128i*)&hash[128], _mm_shuffle_epi8(_mm256_extractf128_si256(r4, 1), mask));
	_mm_store_si128((__m128i*)&hash[144], _mm_shuffle_epi8(_mm256_castsi256_si128(r4), mask));

	_mm_store_si128((__m128i*)&hash[160], _mm_shuffle_epi8(_mm256_extractf128_si256(r5, 1), mask));
	_mm_store_si128((__m128i*)&hash[176], _mm_shuffle_epi8(_mm256_castsi256_si128(r5), mask));

	_mm_store_si128((__m128i*)&hash[192], _mm_shuffle_epi8(_mm256_extractf128_si256(r6, 1), mask));
	_mm_store_si128((__m128i*)&hash[208], _mm_shuffle_epi8(_mm256_castsi256_si128(r6), mask));
