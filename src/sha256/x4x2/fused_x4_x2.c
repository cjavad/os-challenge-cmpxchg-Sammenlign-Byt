...
void sha256x4x2_fused(
...

	{
		...
		__m128i 
		 	mask0 = _mm_load_si128((__m128i*)byteswap_load0),
		...
		__m256
			h0 = M128I_FUSE_PS(hl0, hl1),
			h1 = M128I_FUSE_PS(hu0, hu1);

		__m256
			w0 = _mm256_blend_ps(h0, h1, 0b11001100),
    ...
    __m256
		a = _mm256_permute_ps(h0, 0b00000000),
    ...
    for (uint32_t i = 0; i < 32; i++) {
        ...
        __m128i
            temp2u = _mm_add_epi32(
                m128_S0(M256_UPPER_SI(a)), 
                M256_UPPER_SI(maj)
            ),
            temp2l = _mm_add_epi32(
                m128_S0(M256_LOWER_SI(a)), 
                M256_LOWER_SI(maj)
            ),
    ...
    __m256
		tmp00 = _mm256_unpacklo_ps(a, b),
		tmp01 = _mm256_unpackhi_ps(a, b),
		tmp02 = _mm256_unpacklo_ps(c, d),
		tmp03 = _mm256_unpackhi_ps(c, d),
		tmp10 = _mm256_unpacklo_ps(e, f),
		tmp11 = _mm256_unpackhi_ps(e, f),
		tmp12 = _mm256_unpacklo_ps(g, h),
		tmp13 = _mm256_unpackhi_ps(g, h);
