...
%=:                                # =>This Inner Loop Header: Depth=1
	...
	vpaddd	xmm2, xmm2, xmmword ptr %[WORDS] + ( (15 - 1) * 0x10 )
	...
	vpaddd	xmm2, xmm2, xmmword ptr %[WORDS] + ( (19 - 1) * 0x10 )
	vpaddd	xmm4, xmm7, xmm4
	...
	vpaddd	xmm5, xmm5, xmmword ptr %[WORDS] + ( (20 - 1) * 0x10 )
	...
	vpaddd	xmm8, xmm8, xmm11
	vpaddd	xmm5, xmm8, xmm5
	vpaddd	xmm5, xmm5, xmmword ptr %[WORDS] + ( (21 - 1) * 0x10 )
	...
	vpaddd	xmm5, xmm5, xmmword ptr %[WORDS] + ( (23 - 1) * 0x10 )
	vpaddd	xmm1, xmm5, xmm1
	...
	vpaddd	xmm2, xmm2, xmmword ptr %[WORDS] + ( (24 - 1) * 0x10 )
	vpaddd	xmm13, xmm2, xmm7
	vpaddd	xmm9, xmm5, xmm2
	vpaddd	xmm4, xmm3, xmmword ptr %[WORDS] + ( (22 - 1) * 0x10 )
	...
	vpaddd	xmm5, xmm5, xmm6
	vpaddd	xmm4, xmm5, xmm4
	vpaddd	xmm4, xmm4, xmmword ptr %[WORDS] + ( (25 - 1) * 0x10 )
	vpaddd	xmm2, xmm3, xmm2
	...
	vpaddd	xmm5, xmm5, xmm6
	vpaddd	xmm4, xmm5, xmm4
	vpaddd	xmm4, xmm4, xmmword ptr %[WORDS] + ( (26 - 1) * 0x10 )
	vpaddd	xmm2, xmm3, xmm2
	...
	vpaddd	xmm1, xmm1, xmmword ptr %[WORDS] + ( (27 - 1) * 0x10 )
	...
	vpaddd	xmm3, xmm3, xmmword ptr %[WORDS] + ( (28 - 1) * 0x10 )
	...
	vpaddd	xmm6, xmm6, xmm7
	vpaddd	xmm3, xmm6, xmm3
	vpaddd	xmm6, xmm3, xmmword ptr %[WORDS] + ( (29 - 1) * 0x10 )
	...
	vpaddd	xmm6, xmm4, xmmword ptr %[WORDS] + ( (30 - 1) * 0x10 )
	...
	vpaddd	xmm2, xmm2, xmmword ptr %[WORDS] + ( (32 - 1) * 0x10 )
	...
	vpaddd	xmm2, xmm2, xmmword ptr %[WORDS] + ( (22 - 1) * 0x10 )
	...
	vpaddd	xmm10, xmm11, xmmword ptr %[WORDS] + ( (31 - 1) * 0x10 )
	vpaddd	xmm11, xmm13, xmm12
	vpaddd	xmm12, xmm11, xmmword ptr %[WORDS] + ( (33 - 1) * 0x10 )
...
%=:                                # =>This Inner Loop Header: Depth=1
	...
	vpaddd	xmm7, xmm11, xmmword ptr %[WORDS] + ( (4 - 1) * 0x10 )
