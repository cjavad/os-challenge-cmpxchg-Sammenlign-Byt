...
static __m128i s0(const __m128i w) {
    ...
    return _mm_castps_si128(
        _mm_xor_ps(_mm_castsi128_ps(t0),
...
static __m128i S0(const __m128i a) {
    return _mm_castps_si128(
        _mm_xor_ps(_mm_castsi128_ps(rotr(a, 2)),
                   _mm_xor_ps(_mm_castsi128_ps(rotr(a, 13)),
                              _mm_castsi128_ps(rotr(a, 22)))));
}

static __m128i S1(const __m128i e) {
    return _mm_castps_si128(
        _mm_xor_ps(_mm_castsi128_ps(rotr(e, 6)),
                   _mm_xor_ps(_mm_castsi128_ps(rotr(e, 11)),
                              _mm_castsi128_ps(rotr(e, 25)))));
}

static __m128i ch(const __m128i e, const __m128i f, const __m128i g) {
    return _mm_castps_si128(
        _mm_xor_ps(_mm_and_ps(_mm_castsi128_ps(e), _mm_castsi128_ps(f)),
...
static __m128i maj(const __m128i a, const __m128i b, const __m128i c) {
    return _mm_castps_si128(_mm_xor_ps(
        ...
        _mm_xor_ps(_mm_and_ps(_mm_castsi128_ps(a), _mm_castsi128_ps(c)),
...
static const uint32_t broadH[4 * 8] __attribute__((aligned(16))) = {
    0x6a09e667, 0x6a09e667, 0x6a09e667, 0x6a09e667, 0xbb67ae85, 0xbb67ae85,
    0xbb67ae85, 0xbb67ae85, 0x3c6ef372, 0x3c6ef372, 0x3c6ef372, 0x3c6ef372,
    0xa54ff53a, 0xa54ff53a, 0xa54ff53a, 0xa54ff53a, 0x510e527f, 0x510e527f,
    0x510e527f, 0x510e527f, 0x9b05688c, 0x9b05688c, 0x9b05688c, 0x9b05688c,
    0x1f83d9ab, 0x1f83d9ab, 0x1f83d9ab, 0x1f83d9ab, 0x5be0cd19, 0x5be0cd19,
...
sha256x4_optim(uint8_t hash[SHA256_DIGEST_LENGTH * 4],
    ...
    __m128i a = _mm_load_si128((__m128i *)&broadH[0]),
    ...
    for (uint32_t i = 0; i < 64; i++) {
        ...
        __m128i temp2 = _mm_add_epi32(S0(a), maj(a, b, c)),
                temp1 = _mm_add_epi32(_mm_add_epi32(S1(e), ch(e, f, g)),
